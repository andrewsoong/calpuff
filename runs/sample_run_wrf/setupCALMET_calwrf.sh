...
cat << EOF > calmet.inp
      ...
      * SRFDAT =surf.dat   *               #srfdat the name of the intended SURF.DAT file.
      ...
      * PACDAT = *
      ...
      ! NUSTA  = 0 ! # nusta number of uperair stations used
      ...
      * IEHR  =${iehr} *
      ...
      ! ITEST   = 0   !             #itest    Stop after setup phase? (0:no; 1:yes)  (checking for correctness in model inputs and associated files)
     ...
     ! STABILITY = T ! #stability whether to print the PGT stability class (will only print if lprint is TRUE).
      ...
      ! IOUTD  = 0   ! #ioutd whether to print the test/debug wind fields to disk files.
      ...
      ! NOOBS = 2 ! #"no observation mode"                             
                                                            
      Numbers of surface met and precipitation stations
      ! NSSTA = 0!   # nssta number of surface meteorological stations used.
      ! NPSTA = 0!   # npsta number of precipitation stations used; a value of -1 is to be provided when MM5/3D precip data is used.
                         
      Cloud data options
      ! ICLOUD = 3 ! # cloud data to use,(0: cloud information is not to be used; 1:cloud.dat; 2: gridded cloud.dat; 3: from prognostic fields).
      ...
      ! IWFCOD  = 0   ! # (0) objective analysis only, or (1) diagnostic wind module.
      ...
      ! IEXTRP  = 1   ! # extrapolate surface wind observations to upper layers.
      ...
      ! IPROG   = 15   !#iprog use gridded prognostic wind field model output fields as 
				input to the diagnostic wind field model.
				(0 = No, [IWFCOD = 0 or 1] (Default)
      ...
      ! RPROG   = 1.0 ! # relative weighting parameter of the prognostic wind field data.
     ...
     ! END ! // end SECTION 5
      ...
      ! IMIXH   = -1   ! #method for convective mixing height:  (*OJO*) DEBE SER -1 PARA mreg=1                                                           
      ...
      ! ICOARE =0 ! #method for computation of overwater surface fluxes: (*OJO*) DEBE SER 0 si mreg=1                                         
      ...
      ! ITPROG =  2    !  #selection of temperature data from observations or prognostic data                                                  
