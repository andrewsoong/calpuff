...
ss1=$(printf '%4s,%7.0f,%7.3f,%7.3f,%7.0f,%7.0f' $sfc_name $id_sfc $sfc_x $sfc_y $utmzn $sfc_z)
us1=$(printf '%4s,%6.0f,%7.3f,%7.3f,%7.0f' $up_name $id_up $up_x $up_y $utmzn)
ps1=$(printf '%4s, %7.0f, %7.3f,%7.3f' $sfc_name $id_sfc $sfc_x $sfc_y)
...
cat << EOF > calmet.inp
     ...
     ! END ! // end SECTION 5
      ...
      ! DPTMIN = 0.001  !  #min potential temp lapse rate in the stable layer above the current convective mixing height                     ! DZZI   = 200    !  #depth of layer (in meters) above current convective mixing height through which lapse rate is computed.
